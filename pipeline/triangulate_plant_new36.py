...
CAP_DIR = '/home/khai/semantic-mapping/hawkbot_capture_new36'
...
for i, fname in enumerate(frame_files):
    ...
    for (px, py, conf, box) in dets:
        ...
        all_rays.append({'frame': i, 'origin': cam_origin, 'dir': ray_world, 'conf': conf, 'hist': hist,
                          'orig_idx': int(fname.split('_')[1].split('.')[0])})
...
with open('/home/khai/semantic-mapping/triangulated_plant_new36.json', 'w') as f:
    json.dump(visit_points, f, indent=2)
print('\nda luu triangulated_plant_new36.json')
