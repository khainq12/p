...
CAP_DIR = '/home/khai/semantic-mapping/hawkbot_capture_new47'
...
with open('/home/khai/semantic-mapping/triangulated_plant_new47.json', 'w') as f:
    json.dump(visit_points, f, indent=2)
print('\nda luu triangulated_plant_new47.json')
