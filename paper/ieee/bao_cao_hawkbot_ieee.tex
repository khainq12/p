...
\includegraphics[width=\textwidth,height=3.0cm,keepaspectratio]{paper_figs/paperfig_new36.pdf}
\caption{Session 1 --- \SI{2.77}{\meter}}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
\includegraphics[width=\textwidth,height=3.0cm,keepaspectratio]{paper_figs/paperfig_new46.pdf}
\caption{Session 2 --- \SI{2.76}{\meter}}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
\includegraphics[width=\textwidth,height=3.0cm,keepaspectratio]{paper_figs/paperfig_new47.pdf}
\caption{Session 3 --- \SI{3.13}{\meter}}
\end{subfigure}

\vspace{0.1em}
\begin{subfigure}[t]{0.32\textwidth}
\includegraphics[width=\textwidth,height=3.0cm,keepaspectratio]{paper_figs/paperfig_new48.pdf}
\caption{Session 4 --- \SI{3.08}{\meter}}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
\includegraphics[width=\textwidth,height=3.0cm,keepaspectratio]{paper_figs/paperfig_new49.pdf}
\caption{Session 5 --- \SI{3.26}{\meter}}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
\includegraphics[width=\textwidth,height=3.0cm,keepaspectratio]{paper_figs/paperfig_new50.pdf}
